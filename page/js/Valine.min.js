    ...
    function(e, t, n) {
        ...
        r.prototype.init = function(e) {
            ...
            try {
                ...
                t.locale = t.locale || h[e.lang || "zh-cn"],
                t.notify = e.notify || !1,
                t.verify = e.verify || !1;
                var c = s ? "&q=" + Math.random().toString(32).substring(2) : "";
                v.params = "?d=" + (i.indexOf(o) > -1 ? o: "mp") + "&v=1.3.3" + c,
                v.hide = "hide" === o,
                v.cdn = !!l && l || v.cdn,
                b = e.path || b;
                var u = Number(e.pageSize || 10);
                if (e.pageSize = isNaN(u) ? 10 : u < 1 ? 10 : u, a.setOptions({
                    renderer: new a.Renderer,
                    highlight: !1 === e.highlight ? null: p,
                    gfm: !0,
                    tables: !0,
                    breaks: !0,
                    pedantic: !1,
                ...
                20);
                var f = e.app_id || e.appId,
                m = e.app_key || e.appKey,
                x = (e.region || "cn").toLowerCase(),
                w = ["cn", "us"];
                if (x = w.indexOf(x) > -1 ? x: w[0], !f || !m) throw 99;
                ...
                for (var k = d.findAll(document, ".valine-comment-count"), _ = 0, A = k.length; _ < A; _++) !
                function(e, n) {
                    var r = k[e];
                    if (r) {
                        var i = d.attr(r, "data-xid");
                ...
                e.visitor && y.add(AV.Object.extend("Counter"));
                var O = e.el || null,
                S = d.findAll(document, O);
                if (! (O = O instanceof HTMLElement ? O: S[S.length - 1] || null)) return;
                t.el = O,
                t.el.classList.add("v"),
                v.hide && t.el.classList.add("hide-avatar"),
                e.meta = (e.guest_info || e.meta || g).filter(function(e) {
                    return g.indexOf(e) > -1
                });
                var $ = (0 == e.meta.length ? g: e.meta).map(function(e) {
                    var n = "mail" == e ? "email": "text";
                    return g.indexOf(e) > -1 ? '<input name="' + e + '" placeholder="' + t.locale.head[e] + '" class="v' + e + ' vinput" type="' + n + '">': ""
                });
                t.placeholder = e.placeholder || "Just Go Go",
                t.el.innerHTML = '<div class="vwrap"><div class="vheader item' + $.length + '">' + $.join("") + '</div> <div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + t.placeholder + '"></textarea><div class="vctrl"><span class="inputvalue" id="inputvalue" style="display:none">输入值</span><span class=vimage-btn>图片</span> | <span class="vemoji-btn">表情</span> | <span class="vpreview-btn">预览</span></div><div class="vemojis" style="display:none;"></div><div class="vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-20" title="Markdown is supported"><a href="https://segmentfault.com/markdown" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="col col-80 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + t.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v1.3.3</div></div><iframe name="ajaxframes" src="./page/smms.html" style="display:none;"</iframe>';
                var E = d.find(t.el, ".vempty");
                t.nodata = {
                    show: function(e) {
                        return E.innerHTML = e || t.locale.tips.sofa,
                        d.attr(E, "style", "display:block;"),
                        t
                    },
                    hide: function() {
                        return d.attr(E, "style", "display:none;"),
                        t
                    }
                };
                ...
                t.loading = {
                    show: function(e) {
                        var n = d.findAll(M, ".vcard");
                        return e ? M.insertBefore(C, n[0]) : M.appendChild(C),
                        t.nodata.hide(),
                        t
                    },
                    hide: function() {
                        var e = d.find(M, ".vloading");
                        return e && d.remove(M, e),
                        0 === d.findAll(M, ".vcard").length && t.nodata.show(),
                        t
                    }
                };
                var T = d.find(t.el, ".vmark");
                t.alert = {
                    show: function(e) {
                        T.innerHTML = '<div class="valert txt-center"><div class="vtext">' + (e && e.text || 1) + '</div><div class="vbtns"></div></div>';
                        var n = d.find(T, ".vbtns"),
                        ...
                        if (n.innerHTML = "" + r + (e && e.type && i), d.on("click", d.find(T, ".vcancel"),
                        function(e) {
                            t.alert.hide()
                        }), d.attr(T, "style", "display:block;"), e && e.type) {
                            var o = d.find(T, ".vsure");
                            d.on("click", o,
                            function(n) {
                                t.alert.hide(),
                                e.cb && e.cb()
                    ...
                    hide: function() {
                        return d.attr(T, "style", "display:none;"),
                        t
                    }
                },
                t.bind(e)
                ...
                if (n.length) {
                    ...
                    i.find().then(function(e) {
                        ...
                        function(e, t) {
                            ...
                            o = d.find(i, ".leancloud-visitors-count");
                            o && (o.innerText = r)
                        })
                    }).
                    catch(function(e) {})
        ...
        r.prototype.bind = function(e) {
            ...
            function(e) {
              var n = d.find(t.el, ".veditor");	
                    ...
                    E(n, document.getElementById("inputvalue").innerText),
					y(n) 
            }),
            d.on("click", i,
            function(e) {
            ...
            C = function(e) {
                ...
                r = d.find(n, ".vquote");
                return r || (r = d.create("div", "class", "vquote"), n.appendChild(r)),
                r
            },
            M = function n() {
                var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
                i = e.pageSize,
                o = Number(d.find(t.el, ".vnum").innerText);
                t.loading.show();
                var a = t.Q(b);
                a.limit(i),
                a.skip((r - 1) * i),
                a.find().then(function(e) {
                    ...
                    u.innerHTML = i * r < o ? '<button type="button" class="vmore vbtn">' + t.locale.ctrl.more + "</button>": "";
            ...
            z = function(e) {
                setTimeout(function() {
                    e.offsetHeight > 180 && (e.classList.add("expand"), d.on("click", e,
                    function(t) {
            ...
            U = function(e) {
                if (d.attr(I, "disabled")) return void t.alert.show({
                    type: 0,
                    text: t.locale.tips.busy + 'ヾ(๑╹◡╹)ﾉ"',
                    ctxt: t.locale.ctrl.ok
                });
                if ("" == f.comment) return void _.comment.focus();
                f.nick = f.nick || "Anonymous";
                var n = w.mail(f.mail),
                r = w.link(f.link);
                f.mail = n.k ? n.v: "",
                f.link = r.k ? r.v: "",
                t.notify || t.verify ? F(Q) : Q()
            },
            P = function() {
                var e = new AV.ACL;
            ...
            Q = function() {
                ...
                n = new e;
                if (f.url = decodeURI(b), f.insertedAt = new Date, R.rid) {
                    var r = R.pid || R.rid;
                    n.set("rid", R.rid),
                    n.set("pid", r),
                    f.comment = '<a class="at" href="#' + r + '">' + R.at + "</a>" + f.comment
                }
                ...
                n.setACL(P()),
                n.save().then(function(e) {
                    "Anonymous" != f.nick && m && m.setItem("ValineCache", JSON.stringify({
                        nick: f.nick,
                        link: f.link,
                        mail: f.mail
                    }));
                    ...
                    try {
                        if (R.rid) {
                            var i = d.find(t.el, '.vquote[rid="' + R.rid + '"]') || C(R.rid);
                            T(e, i, !0)
                        } else n ? (r = Number(n.innerText) + 1, n.innerText = r) : d.find(t.el, ".vcount").innerHTML = '<span class="num">1</span> ' + t.locale.tips.comments,
            ...
            d.on("click", I, U),
            d.on("keydown", document,
            function(e) {
                e = event || e;
                var n = e.keyCode || e.which || e.charCode;
                if (((e.ctrlKey || e.metaKey) && 13 === n && U(), 9 === n) && "veditor" == (document.activeElement.id || "")) {
                    e.preventDefault();
                    var r = d.find(t.el, ".veditor");
                    E(r, "    ")
                }
            })
        };
